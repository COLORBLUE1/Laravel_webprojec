                ...
                <div class="relative px-4 py-10 bg-white shadow-lg sm:rounded-3xl sm:p-20">
                    <div class="max-w-md mx-auto">
                        <div class="flex flex-wrap content-center justify-center">
                            <img src="<?php echo e(asset('img/logo.svg')); ?>" class="h-24" />
                        </div>
...
<?php echo $__env->make('front.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\papa2\resources\views/welcome.blade.php ENDPATH**/ ?>